...
arr_psd_folder = "ARR_PSD_"+high_low+'_'+str(n_per_seg)+"_"+str(t_seg)+"_"+"PERTURBED"+"_"+"bi"+"_"+"04"+"/"
perturbation_filepath = "/project/shriniwas/RFClassification/two_class_perturbation_001.npy"
main_folder = dronerf_raw_path


def process_and_save_incrementally(checkpoint_dir='/project/shriniwas/checkpoints'):
    """
